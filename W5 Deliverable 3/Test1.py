...
# ------------------------------------------------------------------
# PATH CONFIGURATION
# Finds the folder containing THIS script, then points to the file.
# ------------------------------------------------------------------
BASE_DIR = Path(__file__).resolve().parent
INPUT_PATH = Path.home() / "Downloads" / "concatenate_chch.csv"
# Alternative: If your CSV is in a subfolder (e.g., 'data/concatenate_chch.csv'):
# INPUT_PATH = BASE_DIR / "data" / "concatenate_chch.csv"
...
def load_data(path: Path | str) -> pd.DataFrame:
    ...
    if not file_path.exists():
        raise FileNotFoundError(
            ...
            f"Please place 'concatenate_chch.csv' in the same folder as this script:\n"
            f"{file_path.parent}\n"
        )
