...
The input is `../Concatenate_Chch_Data/concatenate_chch.csv`, created in
Deliverable 3 from Inside Airbnb Christchurch snapshots covering October 2025
to June 2026.

The cleaned file is saved to `data/christchurch_listings_clean.csv`.
...
`data/bond_data_timeframe.csv`. The cleaning code is in
`clean_bond_data.py`.
...
The bond data went from 27,212 rows to 27,118 rows. The cleaned file is saved as
